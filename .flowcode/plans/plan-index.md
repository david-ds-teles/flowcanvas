...
|--------|------|--------|----------|--------|------|-------|
| `001-initial-architecture` | Flowcanvas v0.1 | complete | 7/7 | [design](001-initial-architecture/001-initial-architecture-design.md) | [plan](001-initial-architecture/001-initial-architecture-plan.md) | **Complete** — Flowcanvas v0.1 shipped: standalone Next.js 16 / React Flow canvas over flowcode markdown with `links:`-derived + manual edges, content nodes (md/image/link/note + fallback), pinned comment threads, and a bidirectional idempotent human↔agent JSON round-trip; 7 guarded fs routes; nyx glass UI (mockup 04). Post-exec artifacts: technical-overview, changelog, test-notes, qa-report. Gates: tsc 0 · lint 0 · build ok · vitest 56/56 · CDP visual-parity 18/18 |
